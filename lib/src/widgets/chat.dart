...
class Chat extends StatefulWidget {
  ...
  /// Allows you to replace the default bootm widget (Attachment and Input)
  /// e.g. if you want to create a channel view.
  /// If you're looking for the bottom widget added to the chat
